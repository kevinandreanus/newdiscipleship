    ...
    <div class="login-wrapper d-flex align-items-center justify-content-center">
      <div class="custom-container">
        ...
        <div class="register-form mt-4">
          <h6 class="mb-3 text-center">Log in to continue to Discipleship.</h6>
          <form method="POST" action="{{ route('login') }}">
            @csrf
            ...
            <div class="form-group position-relative">
              <input class="form-control @error('password') is-invalid @enderror" id="psw-input" name="password" type="password" placeholder="Enter Password" required>
        ...
        <!-- Login Meta -->
        <div class="login-meta-data text-center"><a class="stretched-link forgot-password d-block mt-3 mb-1" href="{{ route('password.request') }}">Forgot Password?</a>
