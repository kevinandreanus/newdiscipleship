      ...
      <div class="offcanvas-body p-0">
        ...
        <div class="sidenav-wrapper">
          ...
          <div class="sidenav-profile bg-gradient">
            ...
            <div class="div">
              @if (Auth::user())
                <a style="color: whitesmoke; font-size: 12px; cursor: pointer" href="/edit-profile/{{ Crypt::encryptString(Auth::user()->id) }}" id="viewProfile">View Profile</a>
              @endif
            </div>
          </div>
          <!-- Sidenav Nav -->
          <ul class="sidenav-nav ps-0">
            ...
            <li><a href=""><i class="fas fa-bible"></i>Bible
